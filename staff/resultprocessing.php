<?php
    ...
    $staffname =strtoupper($staf[0]." ".$staf[1]." ".$staf[2]);
    $dept = $staff['category'];
    $staffid = $staff['StaffId'];
    $courseTaken = $staff['CourseTaken'];
    ...
    $error =[];
        ...
        $courseId = [];
          ...
          $i = array_search($courseTaken, $courseTitle);
          // echo "Previous <br>";
          // echo "score".print_r($scoress)."<br> grades". print_r($gradess)."<br>";
    ...
    // echo print_r($a);
        if(isset($_POST['uploadResult'])){
            if(isset($_POST['scores'])){
                ...
                $class = "";
                $score= $_POST['scores'];
                for ($j=0; $j <= array_key_last($courseId) ; $j++) { 
                  if($j==$i){
                    // $scores[$j] = $score;
                    $score = $_POST['scores']; 
                  }else {
...
// total unit point for each course selected;
                for ($i=0; $i <= array_key_last($courseId) ; $i++) { 
                  $point = $points[$i];
                  $units = $courseUnit[$i];
                  $totalpo = $point* $units;
            ...
            // echo "Former <br>";
            echo "Scores = ". print_r($scores). "<br>";
            echo "Grades = ". print_r($grade). "<br>";
            echo "points = ". print_r($points). "<br>";
            echo "unit = ". print_r($courseUnit). "<br>";
            echo "tottal points = ". print_r($totalunitpoint);
          ...
          echo "<br> Class = $class <br>";
                    ...
                    if($updat){
                        ...
                        header("location:resultprocessing.php?id=$id");
                    }else{
...
<head>
    ...
    <title><?php echo "$staffname compute  $studentname" ?> Dashboard</title>
                ...
                <div class="text-center">
                  <img class="img-fluid card-img"
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                      ...
                      <li class="list-group-item"> <h2> <b><?php echo $studentname ?></b></h2>
                        </li>
          ...
          <div class="col-md-7">
            <div class="card">
              <div class="card-header p-2">
                  ...
                  <h1 class="text-center btn btn-primary btn-lg btn-block"> <?php echo $studentname ?> Registered course</h1>
