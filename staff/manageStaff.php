        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Manage Staffs for <b> <?php echo $dept ?></b></h1>
            </div>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $std =mysqli_query($conn, "SELECT* FROM staff WHERE category = '$dept'");
                  $id =1;
              ...
              <td> <?php
                ...
                <td>
                    <a href="staffDetails.php?id=<?php echo $staffId;?>">View</a><?php if($staffId ==$staffid){ ?>|<a href="staffUpdateProfile.php?id=<?php echo $staffId;?>">Edit</a><?php } ?>
                </td>
              </tr>
              <?php
              $id++;
