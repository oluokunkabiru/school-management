          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header p-2">
                <h1>Course For Current Semester</h1>
                <?php
                 $re = mysqli_query($conn, "SELECT  SUM(courseUnit) AS totalunit FROM registeredcourese WHERE studentId = '$studentId' AND semester ='$semester' AND level = '$level'");
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <form class="" role="form" action="" method="POST" id="courseRegisterForm" >
                      ...
                      <?php
                      $id = 1;
                        $reg = mysqli_query($conn, "SELECT* FROM courses WHERE CourseCategory = '$dept' AND CourseLevel = '$level' ");
                    ...
                    <tr>
                      ...
                      <td><input type="checkbox" name="course[]" id="course" value="<?php echo $course['CourseId'] ?>"></td>
