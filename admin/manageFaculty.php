      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <a href="#newfaculty" class="btn btn-lg btn-info" data-toggle="modal">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $std =mysqli_query($conn, "SELECT* FROM faculty");
                  $id =1;
                  while($faculty = mysqli_fetch_array($std)){
              ...
              <td><?php echo $id ?></td>
              <td><?php echo $name ?></td>
              <td><?php echo htmlentities($faculty['dean'] )?></td>
              <td>
              ...
              <td><?php echo htmlentities($faculty['FacultyReg_date'] )?></td>
              
                <td>
                  <a href="facultyUpdate.php?id=<?php echo $facultyId;?>">Edit</a>|<a href="">Delete</a>
                </td>
              </tr>
              <?php
              $id++;
