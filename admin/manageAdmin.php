          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $std =mysqli_query($conn, "SELECT* FROM admin");
                  $id =1;
                  while($staff = mysqli_fetch_array($std)){
                    $name = htmlentities(strtoupper($staff['name']));
              ...
              <td><?php echo htmlentities($staff['Phone_Number'] )?></td>
                ...
                <td>
                  <a href="staffDetails.php?id=<?php echo $adminId;?>">View</a>|<a href="adminUpdateProfile.php?id=<?php echo $adminId;?>">Edit</a>|<a href="">Delete</a>
                </td>
              </tr>
              <?php
              $id++;
